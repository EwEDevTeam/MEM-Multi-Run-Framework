...
Public Class cProcessMonitorEventArgs
    Inherits EventArgs

    Public Sub New(process As Process, state As cProcessMonitor.eProcessHeartbeat)
        Me.Process = process
        Me.State = state
    End Sub

    Public ReadOnly Property Process As Process
    Public ReadOnly Property State As cProcessMonitor.eProcessHeartbeat
