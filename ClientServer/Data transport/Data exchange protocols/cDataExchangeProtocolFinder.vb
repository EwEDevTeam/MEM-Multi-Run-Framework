...
Public Class cDataExchangeProtocolFinder

    Public Shared Function GetProtocols() As cDataExchangeProtocol()
        Return cTypeUtils.FindType(Of cDataExchangeProtocol)
    End Function
