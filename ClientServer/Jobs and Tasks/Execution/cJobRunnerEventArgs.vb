...
Public Class cJobRunnerStatusEventArgs
    Inherits EventArgs

    Public Sub New(p_jobName As String, p_update As cJobRunUpdate)
        Me.JobName = p_jobName
        Me.SerializableUpdate = p_update
    End Sub

    Public ReadOnly Property JobName As String
    Public ReadOnly Property SerializableUpdate As cJobRunUpdate
